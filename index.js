...
let cc = ` First step is done now!`;
          let session_id = await dreaded.sendMessage(dreaded.user.id, { text: c });    

          await dreaded.sendMessage(dreaded.user.id, { text: cc } , { quoted : session_id });*/
